...
function renderHome() {
    let productsList = (JSON.parse(localStorage.getItem('products')) || window.products || []).slice();
    ...
    // Filter out products with missing name or price
    productsList = productsList.filter(product => product.name && product.price !== undefined && product.price !== null);
